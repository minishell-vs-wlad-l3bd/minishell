...
/*   Updated: 2025/06/15 16:42:28 by aayad            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	analys_syntax(char *line, t_mini *mini)
{
	...
	if (check == 2)
		return (ft_putendl_fd("syntax error: duplicated token 1", 2),
			mini->exit = 258, 0);
	if (check == 4)
		return (ft_putendl_fd("syntax error: near unexpected token 2", 2),
			mini->exit = 258, 0);
	if (check == 0)
		return (ft_putendl_fd("syntax error: near unexpected token 3", 2),
			mini->exit = 258, 0);
	if (check == 3)
